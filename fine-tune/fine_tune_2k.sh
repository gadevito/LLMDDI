...
if [ "$#" -lt 2 ]; then
  ...
  echo "Options for <model name>: deepseek-r1, phi3.5-2b-2k, gemma-2-9b, qwen2.5-3b"
...
case $MODEL_NAME in
  ...
  *)
    ...
    echo "Valid options: deepseek-r1, phi3.5-2b-2k, gemma-2-9b, qwen2.5-3b"
    exit 1
    ;;
esac
