    ...
    for attempt in range(5):
        try:
            ...
            response = client.models.generate_content(
                model=model,
                contents=types.Part.from_text(USER_DDI_CLASSIFICATION.format(drug1=drug1, smiles1=smiles1, org1=org1, genes1=genes1, drug2=drug2, smiles2=smiles2, org2=org2, genes2=genes2)),
                config=types.GenerateContentConfig(
                    system_instruction=SYSTEM_DDI_CLASSIFICATION,
                    temperature= 0,
                ),
            )
