...
def classify(drug, model="gemini-1.5-pro",backoff_factor=1.0):
    for attempt in range(5):
        try:
            ...
            response = client.models.generate_content(
                model=model,
                contents=types.Part.from_text(USER_DDI_CLASSIFICATION_RC.format(drug1=drug1, smiles1=smiles1, org1=org1, genes1=genes1, drug2=drug2, smiles2=smiles2, org2=org2, genes2=genes2)),
