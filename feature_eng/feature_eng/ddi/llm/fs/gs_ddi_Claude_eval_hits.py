...
def classify(sel, drug, model="claude-3-5-sonnet-20241022",backoff_factor=1.0, random_examples=False, num_examples=10, perturbation=False):
        ...
        try:
            ...
            if perturbation:
                ...
                response = client.messages.create(
                                                model=model,
                                                max_tokens=2000,
                                                system=SYSTEM_DDI_CLASSIFICATION_RC_SEMANTIC,
                                                messages=msg,
                                                temperature = 0
                                            )
            else:
...
def main(model, drugbank_pickle, dataset_pickle, output_pickle, batch_size, num_workers, random_examples, num_examples, perturbation):
...
if __name__ == "__main__":
    ...
    main(args.model, args.drugbank_pickle, args.dataset_pickle, args.output_pickle,  args.batch_size, args.num_workers, args.random_examples, args.num_examples, args.perturbation)