#
# The following script opens a dataset, and uses Anthopic to classify the ddi
...
def classify(sel, drug, model="claude-3-5-sonnet-20241022",backoff_factor=1.0, random_examples=False, num_examples=10, ablation=1):
    for attempt in range(5):
        try:
            ...
            examples = sel.format_examples_abalation(sim, ablation)
            ...
            response = client.messages.create(
                                                model=model,
                                                max_tokens=2000,
                                                system=SYSTEM_DDI_CLASSIFICATION_RC,
                                                messages=msg,
                                                temperature = 0
                                            )
            ...
            #print(USER_DDI_CLASSIFICATION_RC.format(drug1=drug1, smiles1=smiles1, org1=org1, genes1=genes1, drug2=drug2, smiles2=smiles2, org2=org2, genes2=genes2))
            #print(cleaned_text)
...
def main(model, drugbank_pickle, dataset_pickle, output_pickle, batch_size, num_workers, random_examples, num_examples, ablation):
...
if __name__ == "__main__":
    ...
    main(args.model, args.drugbank_pickle, args.dataset_pickle, args.output_pickle,  args.batch_size, args.num_workers, args.random_examples, args.num_examples, args.ablation)